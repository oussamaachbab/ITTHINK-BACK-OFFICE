        ...
        <div class="w-full max-w-lg bg-white shadow-md rounded-lg p-6">
            ...
            <form action="update_user.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo isset($user_data['email']) ? htmlspecialchars($user_data['email']) : ''; ?> class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"/>
                </div>
